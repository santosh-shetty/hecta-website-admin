        ...
        <div class="animate__animated p-6" :class="[$store.app.animation]">
            <div x-data="form">
                ...
                <ul class="flex space-x-2 rtl:space-x-reverse pb-5 ">
                    <li>
                        <a href="javascript:;" class="text-primary hover:underline">Category</a>
                    </li>
                ...
                <form action="#" method="post">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="grid grid-cols-1 gap-6 pt-5 lg:grid-cols-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="CategoryTitle" type="text" placeholder="Enter Category Title"
                                        class="form-input" required />
                                </div>
                                <div class="form-group">
                                    <label for="CategoryTitle">Slug</label>
                                    <input id="CategoryTitle" type="text" placeholder="Enter Category Slug"
                                        class="form-input" required />
                                </div>
                                <div class="form-group">
                    ...
                    <div class="panel mt-5">
                        ...
                        <div class="mb-2  flex items-center justify-between">
                            <h5 class="text-lg font-semibold dark:text-white-light">Category Description</h5>
                        </div>
                    ...
                    <!-- <div class="panel mt-5">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="grid grid-cols-1 gap-6 pt-5 lg:grid-cols-2">
                                ...
                                <div class="form-group">
                                    <label for="CategoryTitle">SEO Tittle</label>
                                    <input id="CategoryTitle" type="text" placeholder="Enter Category Title"
                                        class="form-input" required />
                                </div>
                                <div class="form-group">

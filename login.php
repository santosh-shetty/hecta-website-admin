        ...
        <div x-data="auth">
            ...
            <div
                ...
                <div
                    ...
                    <div
                        class="relative hidden w-full items-center justify-center bg-[linear-gradient(225deg,rgba(29, 36, 60, 1)_0%,rgba(0, 187, 187, 1)_100%)] p-5 lg:inline-flex lg:max-w-[835px] xl:-ms-32 ltr:xl:skew-x-[14deg] rtl:xl:skew-x-[-14deg]">
                        <div
                            class="absolute inset-y-0 w-8 from-primary/10 via-transparent to-transparent ltr:-right-10 ltr:bg-gradient-to-r rtl:-left-10 rtl:bg-gradient-to-l xl:w-16 ltr:xl:-right-20 rtl:xl:-left-20">
                        </div>
                        <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                            <a href="index.html" class="block w-48 lg:w-72 ms-10">
                                <img src="assets/images/auth/hecta-logo.svg" alt="Logo" class="w-full" />
                            </a>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <!-- <a href="index.html" class="block w-8 lg:hidden">
                                <img src="assets/images/hecta-logo.svg" alt="Logo" class="w-full" />
                            </a> -->
                        ...
                        <div class="w-full max-w-[440px] lg:mt-16">
                            ...
                            <form class="space-y-5 dark:text-white" @submit.prevent="window.location='index.html'">
                                ...
                                <button type="submit"
                                    class="btn dark-btn !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px]">
                                    Sign in
                                </button>
                            </form>

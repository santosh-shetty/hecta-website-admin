        ...
        <div x-data="auth">
            ...
            <div class="relative flex min-h-screen items-center justify-center">
                ...
                <div class="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px] lg:flex-row lg:gap-10 xl:gap-0">
                    <div class="relative hidden w-full items-center justify-center bg-[linear-gradient(225deg,rgba()_0%,rgba())] p-5 lg:inline-flex lg:max-w-[835px] xl:-ms-28 ltr:xl:skew-x-[14deg] rtl:xl:skew-x-[-14deg]">
                        ...
                        <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                            <a href="index.php" class="w-48 block lg:w-72 ms-10">
                                <img src="assets/imagess/hecta-logo.svg" alt="Logo" class="w-full" style="width: 80%;"/>
                            </a>
                            <div class="mt-24 hidden w-full max-w-[430px] lg:block">
                                <img src="assets/imagess/SignUpImage.svg" alt="Cover Image" class="w-full" style="max-width:fit-content;" />
                            </div>
                        </div>
                    </div>
                    <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                        <div class="flex w-full max-w-[440px] items-center gap-2 lg:absolute lg:end-6 lg:top-6 lg:max-w-full">
                            <a href="index.html" class="block w-8 lg:hidden">
                                <img src="assets/css/imagess/hecta-logo.svg" alt="Logo" class="w-full" />
                            </a>
                        ...
                        <div class="w-full max-w-[440px] lg:mt-16">
                            <div class="mb-10">
                                <h1 class="text-3xl light-text font-extrabold uppercase !leading-snug md:text-4xl">
                                    Sign Up</h1>
                            ...
                            <form class="space-y-5 dark:text-white" @submit.prevent="window.location='index.html'">
                                ...
                                <button type="submit" class="btn dark-btn !mt-6 w-full border-0 uppercase shadow-[0_10px_20px_-10px]">
                                    Sign Up
                                </button>
                            </form>
                            ...
                            <div class="text-center dark:text-white my-2">
                                ...
                                <a href="login.php" class="uppercase text-primary underline transition hover:text-black dark:hover:text-white">SIGN
                                    IN</a>

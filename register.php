        ...
        <div x-data="auth">
            ...
            <div class="relative flex min-h-screen items-center justify-center">
                ...
                <div
                    ...
                    <div
                        class="relative hidden w-full items-center justify-center bg-[linear-gradient(225deg,rgba()_0%,rgba())] p-5 lg:inline-flex lg:max-w-[835px] xl:-ms-28 ltr:xl:skew-x-[14deg] rtl:xl:skew-x-[-14deg]">
                        <div

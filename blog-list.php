                                                ...
                                                <div class="p-5">
                                                    <form @submit.prevent="saveUser">
                                                        ...
                                                        <div class="mb-5">
                                                            ...
                                                            <input id="content" type="text" placeholder="Enter Content" class="form-input" x-model="params.content" />
                                                        </div>
                                                        <div class="mb-5">
                                                            <label for="description">Description</label>
                                                            <input id="description" type="text" placeholder="Enter Description" class="form-input" x-model="params.description" />
                                                        </div>
